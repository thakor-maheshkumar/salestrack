...
<div class="form-group">
    <div class="form-row">
        ...
        <div class="col-md-12">
            <label>State</label>
            <input type="text" class="form-control customerstate" id="state"  pattern="^\d+$">
        </div>

        <div class="col-md-12">
            <label>Compnay</label>
            <select id="cpstate" class="form-control cpstate">
            @foreach(\App\Models\Company::all() as $cp)
            <option value="{{$cp->state}}">{{$cp->state}}</option>
            @endforeach
            </select>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 igstvalue" id="igstvalue">
        ...
        <div class="col-md-12 customerigst" id="customerigst">
            {!! Form::label('igst', 'IGST') !!}
