<fieldset class="scheduler-border">
    ...
    <div class="form-group">
        <label>Select Customer Series</label>
    ...
    <div class="form-group">
        ...
        {!! Form::select('customer_group', isset($customerGroup) ? ['' => 'Select Customer Group'] + $customerGroup : [], isset($ledger->customer_group) ? $ledger->customer_group : '', ['class' => 'form-control'] ) !!}
