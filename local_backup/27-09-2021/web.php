...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['admin', 'permission']], function()
{
    ...
    Route::group(['prefix' => 'series'], function(){
        ...
        //Route::post('api/fetch-cities', [SalesController::class, 'fetchCity']);
    });
    ...
    Route::get('warehouse_stock_available_qty/{stock_id}/{warehouse_id}/{batch_id}/qty', 'StockController@getAvailableQty');
...
Route::group(['prefix' => 'admin/masters', 'namespace' => 'Admin', 'middleware' => 'admin'], function() {
    ...
    Route::get('/truncate', 'SupplierGroupController@truncate')->name('supplier-groups.truncate');
    ...
    Route::group(['prefix' => 'account'], function(){
        ...
        //Route::post('fetch-group','GroupController@fetchgroup');
        //Route::pit('fetchgroup','GroupController@fetchgroup')->name('account.fetchgroup');

        Route::POST('fetchgroup', 'GroupController@fetchgroup')->name('account.fetch-group');
...
Route::group(['prefix' => 'admin/transactions', 'namespace' => 'Admin', 'middleware' => 'admin'], function() {
    ...
    Route::group(['prefix' => 'purchase'], function(){
        ...
        Route::get('export','PurchaseReceiptController@export');
    ...
    Route::group(['prefix' => 'sales'], function(){
        ...
        Route::post('getSalesOrderDetails/{id}', 'SalesInvoiceController@getSalesOrderDetails');
