                ...
                success:function(response){
                    ...
                    var tableData='<tr class="new-item add-more-item">'+
                        ...
                        '<td>'+'<select name="source_items['+element_counter+'][source_warehouse]" class="form-control warehousesMahesh" >'+'<option value="'+value.source_warehouse+'">'+value.warehouse.name+'</option>'+'</select>'+'</td>'+
                                    ...
                                    '<td class="add-more-value">'+'<select name="source_items['+element_counter+'][item_name]" class="form-control maheshItem">'+'<option value="'+value.item_id+'">'+value.item_name+'</option>'+'</select>'+'</td>'+
                        ...
                        '<td>'+'{!! Form::select("source_items['+element_counter+'][target_warehouse]", ['' => "Select Warehouse"] + $warehouses, null, ["class" => "form-control default_target_warehouse", "data-name" => "target_warehouse"]) !!}'+'</td>'+
                                    /*
