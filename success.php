<fieldset class="scheduler-border" id="consignee-address">
    <legend class="scheduler-border">Consignee Address Details</legend>
        ...
        <div class="diffrent">
            ...
            <div id="more_consignee_address" class="more_consignee_address" style="display:none">
    <div class="form-group">
        {!! Form::label('branch_name', 'Branch Name') !!}
    ...
    @endforeach
    @elseif(empty($consignee_addresses))
    ...
    @endif
    <div class="form-group">
        {!! Form::Button('+', ['class' => 'btn btn-primary add_consignee_adderess','id'=>'add_consignee_adderess']) !!}
    </div>
</fieldset>
...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on('change','.state-dd', function(){
            ...
            $('.add_consignee_adderess').on('click',function(){
                $('.more_consignee_address').show();
            });
    })
</script>
@endsection
