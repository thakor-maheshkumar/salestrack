...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['admin', 'permission']], function()
{
    ...
    Route::get('stockavailablequantity','StockController@availableQty');
...
Route::group(['prefix' => 'admin/transactions', 'namespace' => 'Admin', 'middleware' => 'admin'], function() {
    ...
    Route::group(['prefix' => 'purchase'], function(){
        ...
        /// new Chanage /// 30-10-2021 ///
        Route::get('purchase-order/createPurchaseReceipt/{id}','PurchaseOrderController@createPurchaseReceipt');
        Route::get('purchase-order/createPurchaseInvoice/{id}','PurchaseOrderController@createPurchaseInvoice');
        ///
        ...
        ///New Route Create for purchase Return  //
        Route::get('purchase-invoice/createPurchaseReturn/{id}','PurchaseInvoiceController@createPurchaseReturn');
...
Route::group(['prefix' => 'admin/reports', 'namespace' => 'Admin', 'middleware' => 'admin'], function() {
    ...
    Route::get('stock-overview-report','StockReportController@stockOverviewReport');
    Route::get('stock-overview-report-data','StockReportController@stockOverviewReportData');
    //Route::get('stock-ledger', 'StockReportController@index');
    Route::resource('payment-report', 'PaymentReportController');

    Route::get('supplier/payment-report','PaymentReportController@supplierPayementReport');
    Route::get('supplier/payment-report/data','PaymentReportController@supplierPayementReportData');
