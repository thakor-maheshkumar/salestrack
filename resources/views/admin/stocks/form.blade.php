...
<div class="form-group">
    <div class="form-row">
        <div class="col-md-12">
            ...
            {!! Form::select('default_source_warehouse', ['' => 'Select Warehouse'] + $warehouses, null, ['class' => 'form-control source_warehouse warehouse_select', 'id' => 'default_source_warehouse','required'=>'required']) !!}
...
//// New Coding for material Receipt
        ...
        $(document).on('change','.receipt_value',function(){
            ...
            $.ajax({
                ...
                dataType:'JSON',
                success:function(response){
                    $('#default_target_warehouse').prop('required',true);
