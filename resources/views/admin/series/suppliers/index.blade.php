...
@section('content')
    <div class="content">
                ...
                <a href="{{route('supplier.create')}}" class="btn btn-primary seriesadd">Add</a>
                ...
                <div>
                    <div class="list-group">
                        <div class="row">
                            <div class="col-md-12">
                                @if(isset($supplierseries) && count($supplierseries) > 0)
                        
                                @foreach($supplierseries as $key=>$value)
                                <ul class="list-group">
                                    
                                    <li class="list-group-item">{{$value->series_name}} {!! Form::open(['url' => route('supplier.destroy', $value->id), 'method' => 'DELETE']) !!}
                                                    ...
                                                    <a class="btn btn-success float-right btn-sm" href="{{ route('supplier.edit', $value->id) }}">Edit</a></li>
...
<script type="text/javascript">
    var getdata="{{ url('admin/series/supplierdata') }}/";
</script>
<script type="text/javascript">
