            ...
            <div class="col-md-24">
                ...
                <div class="card main-content--subblock">
                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open([
                                'route' => ['material.update',$series->id],
                                'method' => 'PUT',
...
>
                    ...
                    <div class="material_request" style="display:none">   
                         <div class="form-group">
                            <input type="checkbox" name="prefix" id="checkprefix" value="prefix" {{ $series->prefix=='prefix' ? 'checked' : '' }}><b style="margin-left: 20px;">Prefix</b>
                            @if(!empty($series->prefix_static_charcter))
                            <div class="form-row" id="prefixstatticcharacter">
                                <b>Prefix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="prefix_static_charcter" class="form-control series_static_character" value="{{$series->prefix_static_charcter}}">
                                    </div>
                            </div>
                            @else
                        ...
                        @enderror
                        <div class="form-group">
                            <input type="checkbox" name="suffix" id="checksuffix" value="suffix" {{ $series->suffix=='suffix' ? 'checked' : '' }}><b style="margin-left:20px">Suffix</b>
                            @if(!empty($series->suffix_static_charcter))
                            <div class="form-row" id="suffixstaticcharacter">
                                 <b>Suffix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="suffix_static_charcter" class="form-control series_static_character" value="{{$series->suffix_static_charcter}}">
                                    </div>
                            </div>
                            @else
                    ...
                    <div class="material_request">   
                        <div class="form-group">
                            ...
                            <div class="form-row" id="prefixstatticcharacter">
                                <b>Prefix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="prefix_static_charcter" class="form-control series_static_character" id="prefix_static_charcter"  value="{{$series->prefix_static_charcter}}">
                                    </div>
                            </div>
                            @else
                            <div class="form-row" id="prefixstatticcharacter" style="display:none">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row" id="suffixstaticcharacter">
                                 <b>Suffix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="suffix_static_charcter" class="form-control series_static_character" id="suffix_static_charcter" value="{{$series->suffix_static_charcter}}">
                                    </div>
                            </div>
                            @else
                            <div class="form-row" id="suffixstaticcharacter" style="display:none">
