            ...
            <div class="col-md-24">
                ...
                <div class="card main-content--subblock">
                    <div class="card-header">
                        <h3 class="card-title">Create Purchase Order Request</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row" style="display:none" id="prefixstatticcharacter">
                                <b>Prefix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="prefix_static_charcter" class="form-control series_static_character" value="{{old('prefix_static_charcter')}}">
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row" style="display:none" id="suffixstaticcharacter">
                                 <b>Suffix Static Character *:</b>
                                    <div class="col-md-6">
                                        <input type="text" name="suffix_static_charcter" class="form-control series_static_character" value="{{old('suffix_static_charcter')}}">
                                    </div>
                            </div>
                        </div>
