            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col-md-12">
                        ...
                        @endif -->
                        {!! Form::label('state', 'State') !!}
                        {!! Form::select('consignee_state[]',$states, old('consignee_state[0]', isset($c->state) ? $c->state : ''), ['class' => 'form-control state-dd'] ) !!}
                        @if ($errors->has('consignee_state'))
                            <span class="help-block text-danger">
                                <strong>{{ $errors->first('consignee_state') }}</strong>
                            </span>
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-12">
                ...
                @endif -->
                {!! Form::select('consignee_state[]', ['' => 'Select a State'] + $states, old('consignee_state[0]', ''), ['class' => 'form-control state-dd'] ) !!}
                @if ($errors->has('consignee_state'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('consignee_state') }}</strong>
                    </span>
            ...
            <div class="col-md-12">
               ...
               <!--  {!! Form::text('consignee_city[]', old('consignee_city[0]', ''), ['class' => 'form-control', 'placeholder' => 'City']) !!}
                ...
                @endif -->
                 {!! Form::select('consignee_city[]',[''=>'Select a City']+ $city, old('consignee_city[0]', ''), ['class' => 'form-control city-dd', 'placeholder' => 'City','disabled']) !!}
                @if ($errors->has('consignee_city'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('consignee_city') }}</strong>
                    </span>
