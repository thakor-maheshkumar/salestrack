                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-24 text-right">
                                <form action="{{route('sales.import')}}" method="post" enctype="multipart/form-data" >
                                        @csrf
                                 <input type="file" name="file" required="" style="width: 70px;">
                                <input type="radio" name="import" checked="true"> Append
                                    <input type="radio" name="import" value="override"> Overide
                                <input type="submit" class="btn btn-primary" name="importSubmit" value="IMPORT">
                                 @error('file')
                            ...
                            <table id="group_table" class="table datatable table-condensed">
                                <thead>
                                        ...
                                        <tr>
                                            <th></th>
                                            <th>Ledger Name</th>
                                            <th style="display:none">Customer Group</th>
                                            <th>Under</th>
                                            ...
                                            <th style="display:none">Opening Balance Amount</th>
                                ...
                                @if(isset($tablerow) && count($tablerow) > 0)
                                    @foreach($tablerow as $key => $item)
                                        <tr>
                                            ...
                                            <!-- <td style="display:none">{{ isset($item->customergroups->group_name) ? $item->customergroups->group_name : 'All' }}</td> -->
                                            <td style="display:none">{{$item->customer_group }}</td>
                                            <!-- <td>{{ $item->under }}</td> -->
                                            ...
                                            <td style="display:none">{{$item->is_tds_deductable}}</td>
                                             ...
                                             <td style="display:none">{{$item->opening_balance}}</td>
                                             <td style="display:none">{{$item->opening_balance_amount}}</td>
                                             <td style="display:none">{{$item->customer_number}}</td>
                                             <th style="display:none">{{$item->active}}</th>
