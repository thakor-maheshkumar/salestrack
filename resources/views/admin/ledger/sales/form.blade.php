...
<fieldset class="scheduler-border">
    <legend class="scheduler-border">Ledger Detail</legend>
    <div class="form-group">
        {!! Form::label('ledger_name', 'Customer Name') !!}
    ...
    @if(isset($ledger->customer_number))
    <div class="form-group">
            {!! Form::label('customer_number', 'Customer Number') !!}
                {!! Form::text('customer_number', old('customer_number', isset($ledger->customer_number) ? $ledger->customer_number : ''), ['class' => 'form-control', 'placeholder' => 'Customer Number','readonly']) !!}
    ...
    @elseif(!isset($ledger->customer_number))
    <div class="form-group">
            ...
            <input type="text" name="customer_number" class="form-control"  value="{{$value->prefix_static_character}}{{$value->series_current_digit}}{{$value->suffix_static_character}}" readonly>
            @else
             <input type="text" name="customer_number" class="form-control" placeholder="Customer Number">
             @endif
            @endforeach
    </div>
    @endif
    <div class="form-group">
        {!! Form::label('customer_group', 'Customer Groups') !!}
        {!! Form::select('customer_group', isset($customerGroup) ? ['' => ''] + $customerGroup : [], isset($ledger->customer_group) ? $ledger->customer_group : '', ['class' => 'form-control'] ) !!}
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-12">
                ...
                {!! Form::text('pan_it_no', old('pan_it_no', isset($ledger->pan_it_no) ? $ledger->pan_it_no : ''), ['class' => 'form-control', 'placeholder' => 'PAN/IT No.']) !!}
            ...
            <div class="col-md-12">
                ...
                {!! Form::text('uid_no', old('uid_no', isset($ledger->uid_no) ? $ledger->uid_no : ''), ['class' => 'form-control', 'placeholder' => 'UID No']) !!}
...
{{--
    <fieldset class="scheduler-border">
        ...
        <div class="form-group">
            ...
            <br/>
            {!! Form::radio('is_tds_deductable', 1, isset($ledger->is_tds_deductable) && ($ledger->is_tds_deductable == 1) ? true : true, ['id' => 'is_tds_deductable_yes']) !!}
            {!! Form::label('is_tds_deductable_yes', 'Yes', ['class' => 'form-check-label']) !!}

            {!! Form::radio('is_tds_deductable', 0, isset($ledger->is_tds_deductable) && ($ledger->is_tds_deductable == 0) ? true : false, ['id' => 'is_tds_deductable_no']) !!}
...
<div class="form-group">
    ...
    @include('admin.ledger.sales.consinee_address')
</div>
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('change','#gst_reg_type',function(){
