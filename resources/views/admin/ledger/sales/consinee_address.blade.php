            ...
            <div class="form-group">
                <div class="form-row">
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::select('consignee_city[]',$city, old('consignee_city[0]', isset($c->city) ? $c->city : ''), ['class' => 'form-control city-dd','disabled','required']) !!}
    ...
    <div class="form-group">
        <div class="form-row">
            <div class="col-md-12">
                ...
                @endif -->
                 {!! Form::label('state', 'State') !!}
                {!! Form::select('consignee_state_select[]', ['' => 'Select state'] + $states, old('state', isset($ledger->state) ? $ledger->state : null), ['class' => 'form-control state-dd', 'id' => 'state-dd']) !!}
            </div>
            <div class="col-md-12">
                <!-- {!! Form::label('state', 'State') !!}
