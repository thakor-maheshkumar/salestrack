                            ...
                            <table id="group_table" class="table datatable table-condensed">
                                <thead>
                                        <tr>
                                            <th></th>
                                            <th>Ledger Name</th>
                                            <th style="display:none">Supplier Group</th>
                                            <th>Under</th>
                                            ...
                                            <th style="display:none">Approved Vendor Code</th>
                                ...
                                @if(isset($tablerow) && count($tablerow) > 0)
                                    @foreach($tablerow as $key => $item)
                                        <tr>
                                            ...
                                            <!-- <td style="display:none">{{ isset($item->suppliergroups->group_name) ? $item->suppliergroups->group_name : 'All' }}</td> -->
                                           <td style="display:none">{{$item->supplier_group}}</td>
                                            ...
                                            <td style="display:none">{{$item->is_tds_deductable}}</td>
                                             ...
                                             <td style="display:none">{{$item->approved_vendor_code}}</td>
