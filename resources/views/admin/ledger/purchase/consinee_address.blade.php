            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col-md-12">
                        ...
                        @endif 
                        <!-- {!! Form::hidden('consignee_state[]', old('consignee_state[0]', isset($c->state) ? $c->state : ''), ['class' => 'consignee_state']) !!}
                        {!! Form::select('consignee_state_select[]', $states, old('consignee_state[0]', isset($c->state) ? $c->state : ''), ['class' => 'form-control consignee_state', 'disabled']) !!}
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::select('consignee_city[]',$city, old('consignee_city[0]', isset($c->city) ? $c->city : ''), ['class' => 'form-control city-dd', 'placeholder' => 'City','disabled']) !!}
        ...
        <div class="form-row">
            <div class="col-md-12">
               <!--  {!! Form::label('state', 'State') !!}
                ...
                {!! Form::select('consignee_state_select[]', $states, old('consignee_state[0]', ''), ['class' => 'form-control consignee_state',]) !!}
                @if ($errors->has('consignee_state'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('consignee_state') }}</strong>
                    </span>
                @endif -->
                 {!! Form::label('state', 'State') !!}
                <!-- {!! Form::hidden('consignee_state[]', old('consignee_state[0]', ''), ['class' => 'consignee_state']) !!} -->
                {!! Form::select('consignee_state_select[]',['' => 'Select state'] +$states, old('consignee_state[0]', ''), ['class' => 'form-control consignee_state state-dd',]) !!}
                @if ($errors->has('consignee_state'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('consignee_state') }}</strong>
                    </span>
            ...
            <div class="col-md-12">
                ...
                {!! Form::label('city', 'City') !!}
                <!-- {!! Form::text('consignee_city[]', old('consignee_city[0]', ''), ['class' => 'form-control', 'placeholder' => 'City']) !!} -->
                {!! Form::select('consignee_city[]', ['' => 'Select City'] +$city, old('consignee_city[0]', ''), ['class' => 'form-control consignee_city city-dd','disabled']) !!}
                @if ($errors->has('consignee_city'))
                    <span class="help-block text-danger">
                        <strong>{{ $errors->first('consignee_city') }}</strong>
                    </span>
...
@section('scripts')
    ...
    $(document).ready(function(){
        $(document).on('change','.state-dd', function(){
                ...
                var closest=$(this).closest('.addmore').find(".city-dd");
                //console.log(closest)
