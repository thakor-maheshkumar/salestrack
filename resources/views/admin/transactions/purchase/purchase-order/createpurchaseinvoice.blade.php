        ...
        <div class="row">
            <div class="col-md-24">
                <div class="card card-primary main-content--subblock">
                    ...
                    <!-- /.card-body -->
                    <div class="card-body">
                        {!! Form::open(['url' => route($other->store_link), 'id' => 'create_purchase_invoice', 'enctype' => 'multipart/form-data']) !!}
...
<script type="text/javascript">
    var getdata="{{ url('admin/transactions/purchase/purchase-invoice/getdata/') }}/";
</script>
<script type="text/javascript">
