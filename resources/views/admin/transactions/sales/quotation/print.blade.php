        ...
        <table border="1" class="main-table" style="width:705px">
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    @php
                    $total=((int)$quotation->net_amount - (int)$quotation->items->get(0)->discount);
                    @endphp
                ...
                <tr>
                    ...
                    @if($value->state==$quotation->state)
                ...
                <tr>
                    ...
                    <td align="right">{{$total + (int)$quotation->items->get(0)->tax_amount}}</td>
                </tr>
                <tr>
                    <td colspan="2"></td>
