                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 text-right">
                                ...
                                @if(isset($other->add_link_route) && \Helper::userHasPageAccess($other->add_link_route))
                                    <a href="{{ $other->add_link }}" class="btn btn-success">New Quotation</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                 @if(isset($quotations) && count($quotations) > 0)
                                    @foreach($quotations as $key => $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td class="series_id_value">{{ $item->quotation_no }}</td>
                                            ...
                                            <td class="action--cell">
                                                <ul class="action--links">
                                                    @if(\Helper::userHasPageAccess('quotation.show'))
                                                        <li>
                                                            <a href="{{ route('quotation.show', $item->id) }}" class="btn btn-gray"><i class="fas fa-eye"></i></a>
                                                        </li>
                                                    @endif
                                                    @if(!isset($item->sales_orders) || (isset($item->sales_orders) && $item->sales_orders->isEmpty()))
                                                        @if(\Helper::userHasPageAccess('quotation.edit'))
                                                            <li>
                                                                <a href="{{ route('quotation.edit', $item->id) }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                                            </li>
                                                            <li>
                                                                {!! Form::open(['url' => route('quotation.destroy', $item->id), 'method' => 'DELETE']) !!}
                                                    ...
                                                    @endif
                                                    <li>
                                                        <a href="{{ route('quotation.print', $item->id) }}" class="btn btn-warning"><i class="fas fa-print"></i></a>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="5" align="center">Quatation not found...</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
