...
<div class="form-group">
    {!! Form::label('no_of_unit', 'Additional Cost') !!}
    {!! Form::number('additional_cost', old('no_of_unit', isset($bom->additional_cost) ? $bom->additional_cost : ''), ['class' => 'form-control', 'placeholder' => 'Additional Cost']) !!}
</div>
