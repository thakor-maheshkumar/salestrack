...
<fieldset class="gst-detail-block scheduler-border">
    ...
    <div class="gst-detail-subblock d-none">
        ...
        <fieldset class="gst-detail-block scheduler-border">
            <legend class="scheduler-border">Current GST Detail</legend>
        <div class="form-group">
            <div class="form-row">
                <div class="col-md-12">
...
<div class="form-group">
    ...
    {!! Form::select('default_warehouse', ['' => 'Select a Default Warehouse'] + $warehouses, old('default_warehouse', isset($item->default_warehouse) ? $item->default_warehouse : ''), ['class' => 'form-control default_warehouse'] ) !!}
...
<div class="form-group">
    <div class="form-row">
        <div class="col-sm-12">
            ...
            {!! Form::text('product_code', old('product_code', isset($item->product_code) ? $item->product_code : ''), ['class' => 'form-control product_code', 'placeholder' => 'Product Code']) !!}
...
<div class="form-group">
    ...
    {!! Form::text('pack_code', old('pack_code', isset($item->pack_code) ? $item->pack_code : ''), ['class' => 'form-control pack_code', 'placeholder' => 'Pack Code']) !!}
...
@section('script')
    ...
    <script type="text/javascript">
        $('.testIm').on('click',function(e){
            var unitId=$('.unit_id').val();
            if(unitId=='NA'){
                $('.shipper_pack').prop('disabled',true);
            }
        })
        $(document).ready(function() {
            ...
            if(unitValue=='0'){
                $('.shipper_pack').prop('disabled',true);
                $('#alternate_unit_id').prop('disabled',true);
                $('.default_warehouse').prop('disabled',true);
                $('.product_code').prop('disabled',true);
                $('.pack_code').prop('disabled',true);
                $('.maintain_stock').prop('disabled',true);
                $('.opening_stock').prop('disabled',true);
                $('.convertion_rate').prop('disabled',true);
            }else{
                $('.shipper_pack').prop('disabled',false);
                $('#alternate_unit_id').prop('disabled',false);
                $('.default_warehouse').prop('disabled',false);
                $('.product_code').prop('disabled',false);
                $('.pack_code').prop('disabled',false);
                $('.maintain_stock').prop('disabled',false);
                $('.opening_stock').prop('disabled',false);
                $('.convertion_rate').prop('disabled',false);
            }
        });
        var unitData=$('.unit_id').val();
        if(unitData=='0'){
                $('.shipper_pack').prop('disabled',true);
                $('#alternate_unit_id').prop('disabled',true);
                $('.default_warehouse').prop('disabled',true);
