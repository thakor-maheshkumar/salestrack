<div class="form-group">
    ...
    {!! link_to_route('customer-groups.index', 'Cancel', [], ['class' => 'btn    btn-info']) !!}
...
<div class="form-group">
    ...
    <br/>
    {!! Form::select('under', [0 => 'Select Group'] + $customer_groups, isset($group->under) ? $group->under : '', ['class' => 'form-control'] ) !!}
