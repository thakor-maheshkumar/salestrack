    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            <li class="{{ $elementActive == 'dashboard' ? 'active' : '' }} {{ (\Helper::userHasPageAccess('admin.dashboard')) ? '' : 'not-access' }}">
                ...
                <a  data-toggle="collapse" aria-expanded="true" href="#main_dashboard">
                    <i class="nc-icon nc-bank"></i>
                    <p>{{ __('Dashboard') }}</p>
                </a>
                <div class="collapse sub_tree" id="main_dashboard">
                     <ul class="nav">
                        <li>
                            <a href="{{url('admin/main/dashboard')}}">
            ...
            <li class="{{ in_array($elementActive, ['stock_ledger_report', 'payment_report', 'sales_report', 'purchase_report'])  ? 'active' : '' }} {{ (\Helper::userHasMenuAccess(['stock-ledger.index', 'payment-report.index', 'sales-report.index', 'purchase-report.index'])) ? '' : 'not-access' }}">
                ...
                <div class="collapse sub_tree {{ \Helper::isMenuOpen('reports') }}" id="reports">
                    <ul class="nav">
                        ...
                        <li class="{{ $elementActive == 'stock_ledger_report' ? 'active' : '' }} {{ (\Helper::userHasPageAccess('stock-ledger.index')) ? '' : 'not-access' }}">
                            <a href="{{ url('admin/reports/stock-overview-report') }}">
                                <i class="nc-icon nc-tag-content"></i>
                                <span class="sidebar-normal">{{ __(' Stock Overeview Report ') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="{{ $elementActive == 'payment_report' ? 'active' : '' }} {{ (\Helper::userHasPageAccess('admin/reports/supplier/payment-report')) ? '' : 'not-access' }}">
                            <a href="{{ url('admin/reports/supplier/payment-report') }}">
                                <i class="nc-icon nc-zoom-split"></i>
                                <span class="sidebar-normal">{{ __(' Supplier Payment Report ') }}</span>
                            </a>
                        </li>
