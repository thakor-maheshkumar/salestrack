...
class QuotationController extends CoreController
{
    ...
    */
    ...
    public function getSalesAddressDetails(Request $request)
    {
        $branch_name=$request->branch_name;
            if((int)$branch_name)
            {
                $address_detail=ConsigneeAddress::where('id',$branch_name)->first();
                return response()->json([
            ...
            {
                $address_detail=SalesLedger::where('branchname',$branch_name)->first();
                return response()->json([
                'address_detail'=>$address_detail
                ]);
            }
