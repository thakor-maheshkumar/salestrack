...
<div class="form-group">
    <div class="form-row">
        <div class="col-md-12">
            ...
            {!! Form::select('branch_id', ['' => 'Select a Branch']+ $consignee_address, old('branch_id', isset($order->supplier_id) ? $order->branch_id : ''), ['class' => 'form-control branch_id','id'=>'branch_id'] ) !!}
        </div>
        <div class="col-md-12">
