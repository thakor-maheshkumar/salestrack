...
class CreateDeliveryNoteSeriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_note_series', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('delivery_note_series');
    }
}
