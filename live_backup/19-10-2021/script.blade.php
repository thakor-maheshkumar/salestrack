                ...
                $.ajax({
                    ...
                    success: function (data) {
                       ...
                       /* for(var i =0;i < data.order_details.other_charges.length-1;i++)
                        ...
                        let branch = $('.branch_id');
                        /// 13-10-2021 new code added Here ///
                        ...
                        /// 13-10-2021 new coded finish here
                        branch.empty();
            ...
            if (quotation_id != '')
            {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        let branch = $('.branch_id');
                        branch.empty();
                        /// New Code added date 13-10-2021  ///

                        var mainBranch=data.quotation_details.branch_id;
                        if(mainBranch==0){
                           
                            $('.mainBranch').show();
                            $('.branch_id').hide();
                            $('.mainBranch').val(data.quotation_details.main_branch);
                        }else{
                            $('.mainBranch').hide();
                            $('.branch_id').show();
                            $('.mainBranch').prop('disabled',true);
                        }
                       ////////Ending Code Here 13-10-2021 ///
