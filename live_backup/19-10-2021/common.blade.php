    ...
    <div class="form-row">
        <div class="col-md-12">
            ...
            @elseif(isset($order))
                ...
                {!! Form::select('branch_id', (!empty($consignee_address)) ? ['' => $order->branch]+$consignee_address : [$order->branch => $order->branch], old('branch_id', isset($order->branch_id) ? $order->branch_id : ''), ['class' => 'form-control branch_id','id'=>'branch_id'] ) !!}
            @else
            {!! Form::label('branch_id', 'Branch') !!}
        ...
        <!-- new code Here 13-10-2021 -->
            <input type="text" name="branch_id" class="form-control mainBranch" id="mainBranch" style="display:none">
        <!-- -->
        </div>
