            ...
            <div class="document_no_receipt" style="display:none">
                <label>Document No</label>
                    <select class="form-control receipt_value" name="receiptvalue">
                        ...
                        <option value="{{$documentDataValue->document_no}}" qty_data="{{$documentDataValue->qty}}">{{$documentDataValue->document_no}}</option>
            ...
            @else
                <tr class="new-item">
                    ...
                    <td>
                        ...
                        +$warehouses, null, ['class' => 'form-control source_warehouse warehouse_select', 'data-name' => 'source_warehouse']) !!}
                    </td>
                    <td>
                        <select id="item_name" name="source_items[{{$element_counter}}][item_name]" data-plugin-selectTwo class="form-control item_name select2-elem select2" data-name="item_name" required="required">
                            <option value="">Select Item</option>
...
//// New Coding for material Receipt
                    ...
                    var tableData='<tr class="new-item add-more-item">'+
                        ...
                        '<td>'+'<select name="source_items['+element_counter+'][source_warehouse]" class="form-control warehousesMahesh" >'+'<option value="'+value.source_warehouse+'">'+value.warehouse.name+'</option>'+'</select>'+'</td>'+
                                    ...
                                    */
                                    ...
                                    '<td>'+'<input type="text" name="source_items['+element_counter+'][quantity]"class="form-control source_quantity" value='+value.quantity+'>'+'</td>'+
        ...
        $(document).on('change','.source_quantity',function(){
            ...
            var source_quantity=$('.receipt_value option:selected').attr('qty_data');
                source_quantity=source_quantity.replace('-','');
            if(take_quantity > source_quantity){
