...
<div class="form-group">
    ...
    {!! Form::radio('consignee_address', 0, isset($ledger->consignee_address) && ($ledger->consignee_address == 0) ? true : true, ['class'=>'consignee_address_checkbox','id' => 'consignee_address_no']) !!}
