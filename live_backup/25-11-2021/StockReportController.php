...
class StockReportController extends CoreController
{
    ...
    public function stockOverviewReportData(Request $request)
    {
        ...
        $stockQuantity=StockManagement::where('stock_item_id',$itemname)
                        ...
                        ->where('active',1)
                        ->selectRaw('id,stock_item_id,batch_id,count(document_no) as document_number,warehouse_id,SUM(CASE WHEN qty > 0 THEN qty ELSE qty > 0 END) as quantity,voucher_type')
