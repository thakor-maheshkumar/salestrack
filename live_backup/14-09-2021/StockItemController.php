    ...
    public function edit($id)
    {
        if($id)
        {
            ...
            if($item)
            {
                ...
                return view('admin.inventory.stock-item.edit',compact('unitdata'), ['item' => $item, 'taxablity_types' => self::$taxablity_types, 'stock_groups' => $stock_groups, 'stock_categories' => $stock_categories, 'units' => $units,'warehouses' => $warehouses, 'tax_types' => self::$tax_types, 'supply_types' => self::$supply_types,'grades'=>$grades]);
            }
        }
