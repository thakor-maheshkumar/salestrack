...
'balance_qty'=>isset($quantity_receipt) ? ($quantity_receipt->balance_qty+$source_item['quantity']) : $source_item['quantity'],
                    ...
                    $stockIssueData=StockIssue::where('stock_item_id',$source_item['item_name'])->where('document_no',$request->document_no)->first();
                    ...
                    $stock_op = StockManagement::insert($stock_data);
                        ...
                        if(isset($stockIssueDataOpening)){
                         ...
                         $stockIssueDataOpening->document_no = isset($document_no_add) ?'MR0000'.$document_no_add : $request->receiptvalue;
                         $stockIssueDataOpening->warehouse_id=isset($source_item['source_warehouse']) ? $source_item['source_warehouse'] : NULL;
